...
//n=0; d=0;
// faylni oqish uchun ochish

f=fopen("my_file.dat","rb");
fread(&n,sizeof(int),1,f); // n sonini fayldan oqish
fread(&d,sizeof(double),1,f); // d sonini fayldan oqish
// starni fayldan oqish
