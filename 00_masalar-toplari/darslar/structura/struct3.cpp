...
ofstream yoz("1.txt");
cout << "ishchilar sonni= ";  cin>>t.soni; 
for (int i=0; i <t.soni; i++){

cout<<"Ismi : "; cin>>t.ism; yoz<<t.ism<<endl; cout<< endl;
cout<<"familiya : "; cin>>t.fam; yoz<<t.fam<<endl; cout<< endl;
cout<<"yoshi : "; cin>>t.yosh; yoz<<t.yosh<<endl; cout<< endl;
cout<<"maoshi : "; cin>>t.maosh; yoz<<t.maosh<<endl; cout<< endl;
} 
yoz.close();
