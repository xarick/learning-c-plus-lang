...
string s="assalomu alaykum bolajak_dasturchilar";

cout<<s<<endl;
// 16 - belgidann boshlab 9 ta belgi ocirish
s.erase(16,9);
cout<<s<<endl; // assalomu aalaykum dasturchilar -> chiqadi
// 16- belgidan boshlab satr ohirini o'chirish
s.erase(16);
cout<<s<<endl; // asalamu alaykum ->chiqadi
s.erase();
cout<<s<<endl;// bo'sh satr chiqadi  
