...
string c="mehribon_va_muhtarama_ayollar";
char p[]="salomllashish odobi";

cout<<s<<endl;
// 17-belgidan boshlab yangi satr qoshish
s.insert(17,"aziz_");
cout<<s<<endl; // assalomu alaykum aziz dostlar
//c satridan 8-belgidan boshlab 10 ta belgi qohish
s.insert(21,c,8,10);
cout<<s<<endl; // assalomu alakum aziz_va_muhtaram_do'stlar
// char toiifasidagi satrdan 13 ta belgi qoshish
s.insert(0,p,13);
cout<<s<<endl; 
getch(); //getchar();
system("PAUSE");
