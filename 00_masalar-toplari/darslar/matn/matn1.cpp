...
using namespace std;
int main(){
ofstream yozish; // faylni yozsih uchun ochish
yozish.open("matn01.txt");
// yangi  fayl hosil qilnadi
// agar oldindan bolsa eski qiymatlar o'chiriladi

yozish<<"Ism - Bobur"<<endl;
yozish<<"Familiya - Tohirov"<<endl;
yozish<<"yosh - 20 yosh"<<endl;
cout<<"matn yuklandi!!!"<<endl;
yozish.close();
getch(); //getchar();
// system("PAUSE");
return 0;
