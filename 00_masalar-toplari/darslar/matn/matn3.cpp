...
int main(){
int length;
char *buffer, fayl[]="123.JPG",yangi[]="1111.jpg";
// fayl nushalanadigan fayl nomi  
// yangi yangi nushalangan fayl nomi
  
// oqishh oqimi    
ifstream fromfile(fayl, ios::binary);
if(!fromfile.is_open())
{
   cout<<"bunday fayl yo'q"<<endl;
   exit(1); //dastur tugashi 
}
// yozish oqimi
ofstream tofile(yangi, ios::binary);
//fayl hajmmini aaniqlash
...
//bolkka malumotlani oqish
fromfile.read(buffer, length);
//hotirani boshatish
delete[] buffer;
cout<<"fayl nushalandi\n";
getch(); //getchar();
// system("PAUSE");
return 0;
}
