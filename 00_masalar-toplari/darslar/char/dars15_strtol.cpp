...
char  sonlar[]="2012 A5C 111";
char *pEnd;
long int ta1,ta2,ta3;

ta1=strtol(sonlar,&pEnd,10);
ta2=strtol(pEnd,&pEnd,16);
ta3=strtol(pEnd,&pEnd,2);

cout<<ta1<<endl; // 2012 chiqadi
cout<<ta2<<endl; // 90 chiqadi
cout<<ta3<<endl; // 7 chiqadi
getch(); //getchar();
system("PAUSE");
return 0;
}
