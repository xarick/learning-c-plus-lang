...
char ikki[50],sakkiz[20],on_olti[10];;
int n;
cout<<"o'nlik sanoq sistemasida son kiriting\n";
cin>>n;
// n sonini 2 likga otkzish
itoa(n,ikki,2);
itoa(n,sakkiz,8);
itoa(n,on_olti,16);

cout<<"2 likda -> "<<ikki<<endl;
cout<<"8 likda -> "<<sakkiz<<endl;
cout<<"16 likda -> "<<on_olti<<endl;
getch(); //getchar();
system("PAUSE");
return 0;
}
