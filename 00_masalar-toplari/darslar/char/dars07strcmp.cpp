...
char parol[]="bobur123456";
char s[20];
do{
  cout<<"parolni  kiriting"<<endl;
  cin.getline(s, sizeof(s));
  if(strcmp(parol, s)!=0)
    cout<<"parol noto'g'ri kiritildi"<<endl;       
}while((strcmp(parol, s)!=0));


cout<<"assalomu alaykum bo'lajak dasturchi"<<endl;
