...
#include <stdlib.h>
using namespace std;
float arifmetika(float a, float b, int c)
{   float natija;
    switch(c)
    {
...
cin>>x>>y;
int k;
cout<<" + - / * amallaridan birini kriting";
cout<<" + uchun 1 ni kiriting "<<endl;
cout<<" - uchun 2 ni kiriting "<<endl;
cout<<" * uchun 3 ni kiriting "<<endl;
cout<<" / uchun 4 ni kiriting "<<endl;
cin>>k;
cout<<arifmetika(x,y,k)<<endl;
