...
int main(){
char ikkilik[20],onlik[10];
char *p;
long int n;
cout<<"ikkilik sanoq tizimida son  kiriting "<<endl;
cin.getline(ikkilik,sizeof(ikkilik));

// 2 likdan onliik sanoq tizimiga otish
n=strtol(ikkilik,&p,2);
// 10 likdagi sonni satrga ogirish
itoa(n,onlik,10);
cout<<"bu son onlikda quyidagicha boladi "<<endl;
cout<<onlik<<endl;
