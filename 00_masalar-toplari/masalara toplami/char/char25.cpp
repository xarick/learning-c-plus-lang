...
char onlik[10];
int n;
cout<<"onlik sanoq tizimida son  kiriting "<<endl;
cin.getline(onlik,sizeof(onlik));

// satrni songa ogirish
n=strtol(onlik,&ikkilik,10);

// n sonini 2 lik sanoq sistemasiga ogirish
itoa(n,ikkilik,2);

cout<<"bu son ikkilida quyidagicha boladi "<<endl;
cout<<ikkilik<<endl;
...
// itoa(n,ikki,2); 10 likdagi n ni 2 likga otkazish   
